...
use App\Services\Esim\ResellPortalUserClientService;
...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(ResellPortalUserClientServiceInterface::class, ResellPortalUserClientService::class);
