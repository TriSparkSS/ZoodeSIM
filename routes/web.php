...
Route::prefix('admin')->name('admin.')->middleware('admin.auth')->group(function () {
    ...
    Route::get('/partners/{partner}/referrals', PartnerReferralHistory::class)->name('partners.referrals');
    Route::get('/users', Users::class)->name('users');
    Route::get('/users/{user}/referrals', UserReferralHistory::class)->name('users.referrals');
